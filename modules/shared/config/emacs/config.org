...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Luc Gaitskell"
    user-mail-address "me@lucg.xyz")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/lucg/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/lucg/bin" "/profile/bin" "/Users/lucg/.npm-packages/bin" "/Users/lucg/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
